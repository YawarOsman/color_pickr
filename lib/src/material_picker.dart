        ...
        child: ListView(
          ...
          children: [
            ...
            ..._shadingTypes(_currentColorType).map((Map<Color, String> color) {
              final Color colorValue = color.keys.first;
              return GestureDetector(
                onTap: () {
                  setState(() => _currentShading = colorValue);
                ...
                child: Container(
                  ...
                  child: Align(
                    child: AnimatedContainer(
                      ...
                      width:
                      isPortrait ? (_currentShading == colorValue ? 250 : 230) : (_currentShading == colorValue ? 50 : 30),
                      height: isPortrait ? 50 : 220,
                      decoration: BoxDecoration(
                        color: colorValue,
                        boxShadow: _currentShading == colorValue
                            ? [
                          (colorValue == Colors.white) || (colorValue == Colors.black)
                            ...
                            : null,
                        border: (colorValue == Colors.white) || (colorValue == Colors.black)
                            ? Border.all(color: (Theme.of(context).brightness == Brightness.light) ? Colors.grey[300]! : Colors.black38, width: 1)
                            : null,
                      ),
                      child: widget.enableLabel
                        ...
                        children: [
                          Text(
                            '  ${color.values.first}',
                            style: TextStyle(color: useWhiteForeground(colorValue) ? Colors.white : Colors.black),
                          ),
                          Expanded(
                            child: Align(
                              alignment: Alignment.centerRight,
                              child: Text(
                                '#${(colorValue.toString().replaceFirst('Color(0xff', '').replaceFirst(')', '')).toUpperCase()}  ',
                                style: TextStyle(
                                  color: useWhiteForeground(colorValue) ? Colors.white : Colors.black,
                          ...
                          : AnimatedOpacity(
                        duration: const Duration(milliseconds: 300),
                        opacity: _currentShading == colorValue ? 1 : 0,
                        child: Container(
